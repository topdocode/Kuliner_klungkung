...
@section('main')
    <div class="px-5 pb-3">
        <div class="wrapper d-flex justify-content-between align-items-center">
            <p class="fs-2 text-black fw-semibold">@lang('messages.add_chef_title')</p>
            <div class="dropdown">
        ...
        <form action="{{ route('store-chef') }}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-12 my-2">
                        <div class="row">
                            ...
                            <div class="col-5 mb-3">
                                ...
                                <textarea class="input-text mt-2 w-100" placeholder="Input chef description" name="description" rows="4"></textarea>
                            </div>
                            <div class="col-5 mb-3">
                                <p class="text-black fs-14 fw-medium">@lang('messages.add_chef_form_description') EN</p>
                                <textarea class="input-text mt-2 w-100" placeholder="Input chef description" name="description_translation"
                                    rows="4"></textarea>
                            </div>
                            <div class="col-10">
                                <div class="d-flex flex-row gap-2">
                                    <a href="{{ route('index-chef') }}" class="btn btn-dark">@lang('messages.add_chef_form_button1')</a>
                                    <button type="submit" class="btn btn-color">@lang('messages.add_chef_form_button2')</button>
                                </div>
                            </div>
                        </div>
                    </div>
